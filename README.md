...
![The MeshCore board over the Denver metro — six teams contesting the ground square by square](docs/img/map.png)

*Denver. Colorado Mesh.*

![The board across the Wasatch Front — all seven teams between the Great Salt Lake and the mountains](docs/img/board-salt-lake.png)
...
![The About page — squares claimed, players registered, season end, and the communities where it's played](docs/img/about.png)
