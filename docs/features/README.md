...
| [Places Worth Going](places.md) | A design for scoring named destinations — summits, parks, landmarks — instead of treating every map square the same | Not built — design note only |
